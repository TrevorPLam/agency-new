...
Generated on: 2026-05-13T02:25:38.708Z
Total files: 2

**Description:** Design token pipeline for the Firm platform using DTCG format and Style Dictionary

**Version:** 1.0.0

## Table of Contents

- [test-snapshots.js](#test-snapshots-js)
- [style-dictionary.config.js](#style-dictionary-config-js)

## File Contents

### test-snapshots.js

**Path:** `scripts\test-snapshots.js`
